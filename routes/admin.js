//admin/.....
const {getAddProduct,postAddedProduct,displayAdminProducts,postEdittedProduct,getAdminProdctDetail,postDeleteProduct}=require("../controllers/admin-product-handler")
